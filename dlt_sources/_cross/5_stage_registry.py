# CIANCHOSAINT wholesale-copy of cianchosaint/cianchosaint @ main branch.
#
# Original: cianchosaint/cianchosaint (per the openspec/changes/cianchosaint-repo-bootstrap-v2/specs/cianchosaint-bootstrap-v2/spec.md).
...
# (the BIPP/BIDP/BIIP v1 "4-path ensemble" became the cianchosaint "5-stage
# pipeline").
