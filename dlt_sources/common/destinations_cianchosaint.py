...
#
# This file is the renamed + refactored destinations factory for the
# cianchosaint DLT common layer. The namespace was renamed from
# cianfhoghlaim -> cianchosaint (per the cianchosaint-repo-bootstrap-v2
# openspec change, Requirement: Data platform wholesale-copy):
#
# - DEFAULT_NAMESPACE: cianfhoghlaim -> cianchosaint
# - LAKEHOUSE_DUCKDB: md:cianfhoghlaim -> md:cianchosaint
# - All references to cianfhoghlaim in docstrings updated to cianchosaint
#
# The wholesale-copy of the rest of dlt_sources/common/ remains
# verbatim; only this file has the namespace refactor applied.
#

"""
Environment-aware DuckLake destination factory for cianchosaint.
...
Phase 2.3 of the lateralise change (cianchosaint adaptation): the namespace is now a
...
S3 prefix + Postgres DB name to its own cianchosaint namespace.
...
DEFAULT_NAMESPACE = "cianchosaint"

LAKEHOUSE_DUCKDB: str = "md:cianchosaint"
"""The canonical MotherDuck + DuckLake lakehouse alias for the cianchosaint platform.

Used by the 4 BIEP v3 jurisdiction pipelines + 5 Dagster assets. The
canonical helper is `dlt_sources.common.destinations_cianchosaint.get_dlt_destination()`.
"""
