...
# British Isles Defence Pipeline (BIDP v1) — Republic of Ireland.
#
...
# Source URLs (defence.ie) are Republic of Ireland public-sector OSINT
# and fall within the cianchosaint OSINT allowlist.

"""cianchosaint.cianchosaint.dlt.british_isles.ireland.defence_forces — Irish Defence Forces.

Phase 7 of the openspec change. Covers the 2 BIDP v1 m2 cohort grid
entries for the Republic of Ireland:

- `idf_press_releases` — Irish Defence Forces press releases.
- `idf_white_paper`   — White Paper on Defence.

Honours `USE_LOCAL_SCRAPES=true` falling back to
`stedding/ingest_queue/ireland/defence_forces/`.
"""
