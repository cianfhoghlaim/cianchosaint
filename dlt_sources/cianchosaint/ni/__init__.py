...
# British Isles Policing Pipeline (BIPP v1) — Northern Ireland.
#
...
# Source URLs (PSNI, DoJ NI, NI Policing Board) are British Isles
# public-sector OSINT and fall within the cianchosaint OSINT allowlist.

"""cianchosaint.cianchosaint.dlt.british_isles.ni — Northern Ireland DLT sources.

Phase 7 of the openspec change. Covers the 3 BIPP v1 m3 cohort grid
entries for Northern Ireland:

- `psni_press_releases` — Police Service of Northern Ireland.
- `justice_ni`          — NI Department of Justice.
- `policing_board_ni`   — NI Policing Board (oversight).

Honours `USE_LOCAL_SCRAPES=true` falling back to
`stedding/ingest_queue/ni/policing/`.
"""
