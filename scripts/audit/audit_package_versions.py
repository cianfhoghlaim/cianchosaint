...
PACKAGE_TABLE: list[dict] = [
    ...
    {"name": "infisical",          "kind": "docker", "image": "infisical/infisical", "pinned_ciancho": "v0.165.15", "pinned_cianfhog": "v0.165.15", "policy": "exact", "stage": "2c"},
    ...
    {"name": "crawl4ai",           "kind": "docker", "image": "unclecode/crawl4ai", "pinned_ciancho": "v0.9.4",     "pinned_cianfhog": "v0.9.4",    "policy": "exact", "stage": "2c"},
    {"name": "garage",             "kind": "docker", "image": "dxflrs/garage",      "pinned_ciancho": "v2.4.1",      "pinned_cianfhog": "v2.4.1",     "policy": "exact", "stage": "2c"},
    ...
    {"name": "dagster",            "kind": "pypi", "pypi": "dagster",     "pinned_ciancho": ">=1.13,<2.0","pinned_cianfhog": ">=1.13,<2.0", "policy": "caret", "stage": "3"},
    {"name": "dagster-dlt",        "kind": "pypi", "pypi": "dagster-dlt", "pinned_ciancho": ">=0.29,<1.0", "pinned_cianfhog": ">=0.29,<1.0", "policy": "caret", "stage": "3"},
    {"name": "dagster-dbt",       "kind": "pypi", "pypi": "dagster-dbt", "pinned_ciancho": ">=0.29,<1.0", "pinned_cianfhog": ">=0.29,<1.0", "policy": "caret", "stage": "3"},
    {"name": "cocoindex",          "kind": "pypi", "pypi": "cocoindex",   "pinned_ciancho": ">=1.0.20,<2.0","pinned_cianfhog": ">=1.0.20,<2.0", "policy": "caret", "stage": "3"},
    {"name": "baml-py",            "kind": "pypi", "pypi": "baml-py",     "pinned_ciancho": ">=0.223,<1.0","pinned_cianfhog": ">=0.223,<1.0", "policy": "caret", "stage": "3"},
