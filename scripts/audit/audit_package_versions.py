...
PACKAGE_TABLE: list[dict] = [
    ...
    {"name": "langfuse-worker",    "kind": "docker", "image": "langfuse/langfuse-worker", "pinned_ciancho": "4",  "pinned_cianfhog": "4",         "policy": "exact", "stage": "2b"},
    {"name": "komodo-core",        "kind": "github", "owner": "moghtech/komodo",   "pinned_ciancho": "ferretdb:2 (indirect)", "pinned_cianfhog": "needs-verification", "policy": "exact", "stage": "2b"},
    {"name": "komodo-periphery",   "kind": "github", "owner": "moghtech/komodo",   "pinned_ciancho": "ferretdb:2 (indirect)", "pinned_cianfhog": "needs-verification", "policy": "exact", "stage": "2b"},
    ...
    {"name": "langfuse-py",        "kind": "pypi", "pypi": "langfuse",    "pinned_ciancho": ">=4.0.0",     "pinned_cianfhog": ">=4.15.1 (via logfire)", "policy": "caret", "stage": "3"},
