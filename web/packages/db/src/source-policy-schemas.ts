/**
 * CIANCHOSAINT 7th canonical Convex table — `sourcePolicyIndex`.
 *
 * Per the
 ...
 * mirror of the CocoIndex `cianchosaint.source_policy_index`
 ...
 * `cianchosaint-convex-schemas` spec) applies: the `milestone_gate`
