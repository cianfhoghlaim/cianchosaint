/**
 * CIANCHOSAINT — PipelineGraph component
 *
 * Per the canonical spec at
 * `openspec/specs/cianchosaint-pipeline-graph/spec.md`.
 *
 * Visualises the 5-stage Cianchosaint pipeline (DLT source → BAML
 ...
 * main branch (per the openspec/changes/cianchosaint-repo-bootstrap-v2
...
// cianchosaint-vlm-ocr-pipeline-v1 change)
// ---------------------------------------------------------------------------
  ...
  return (
    ...
    >
      <svg
        ...
        role="img"
        aria-label={`Cianchosaint pipeline graph for ${persona} persona`}
