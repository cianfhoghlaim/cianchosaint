/**
 * CIANCHOSAINT per-source context-aware React component.
 *
 * Per the
 ...
 * `cianchosaint.source_policy_index` LanceDB table, NOT in the
 * component itself.
 */
...
export function SourcePolicyCard({
  ...
  const handle_citation = React.useCallback(() => {
    ...
    const citation: OSINTEvidenceCitation = {
      ...
      source_url: `cianchosaint://source-policy-index/${row.jurisdiction}/${row.source_id}`,
