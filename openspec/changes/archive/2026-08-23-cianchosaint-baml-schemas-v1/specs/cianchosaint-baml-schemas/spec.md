# Spec Delta: cianchosaint-baml-schemas

This delta is applied by the openspec change
[`cianchosaint-baml-schemas-v1`](../proposal.md). It describes the
...
7. **Shared political-party** (`political_party_extraction.baml`) —
   ...
   supersedes the wholesale-copied `baml_src/cianchosaint/processing/party.baml`)
8. **Reform UK pilot dossier** (`reform_uk_dossier_extraction.baml`) —
   `ExtractReformUkDossier` (refines the wholesale-copied
