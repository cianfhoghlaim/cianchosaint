...
# Canonical embedder env knob: CIANCHOSAINT_EMBED_MODEL (per the
    ...
    def repo_embedding_flow(flow_builder, data_scope):
        ...
        with data_scope["files"].row() as file_item:
            ...
            with file_item["chunks"].row() as chunk:
                ...
                # CIANCHOSAINT_EMBED_MODEL is honoured; previous hardcoded
...
async def search_code(
    ...
    # Generate query embedding (canonical env knob CIANCHOSAINT_EMBED_MODEL
