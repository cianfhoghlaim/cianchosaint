...
services:
  locket:
    image: cianchosaint/locket:local
    user: "65532:65532"
...
- **HTTP API** (Pangolin, admin-only): `https://locket.cianchosaint.ie`
